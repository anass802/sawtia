  ...
  return (
    <form  className="flex flex-col gap-4">
          ...
          <button type="button" onClick={() => setShowPw(v => !v)}
            ...
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                d={showPw
                  ? "M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-4-9-7s4-7 9-7a10.05 10.05 0 011.875.175M15 12a3 3 0 11-6 0 3 3 0 016 0zm6.364-3.364A9.956 9.956 0 0121 12c0 3-4 7-9 7"
                  : "M15 12a3 3 0 11-6 0 3 3 0 016 0M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"
                } />
            </svg>
          </button>
        </div>
      ...
      <div>
        ...
        <input
          type={showPw ? "text" : "password"} required value={form.password_confirmation} onChange={set("password_confirmation")}
